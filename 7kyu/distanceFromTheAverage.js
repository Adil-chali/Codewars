// https://www.codewars.com/kata/568ff914fc7a40a18500005c/solutions/javascript?filter=me&sort=best_practice&invalids=false
...
let avg=  arr.reduce((acc,cur)=>acc+cur,0)/arr.length
 return arr.map((x)=>parseFloat((avg - x).toFixed(2)))
}