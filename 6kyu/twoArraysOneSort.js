// https://www.codewars.com/kata/546b22225874d24fbd00005b/javascript
...
function linkedSort(aToSort, aLinked, compare) {
  compare = compare || ((a, b) => (''+a).localeCompare(b));
  let ref = aLinked.slice();
  aLinked.sort((a, b) => compare(aToSort[ref.indexOf(a)], aToSort[ref.indexOf(b)]));
