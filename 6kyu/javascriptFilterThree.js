// https://www.codewars.com/kata/525f0459fb9570f9ff00005d/solutions/javascript?filter=me&sort=best_practice&invalids=false
...
const WrongName=logins.filter((x)=>x.at(-1)==="."||x.at(0)===".")

return WrongName.map((x)=>
 logins[logins.indexOf(x)+1]
